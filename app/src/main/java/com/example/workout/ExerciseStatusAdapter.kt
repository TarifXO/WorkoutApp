...
import com.example.workout.databinding.ItemeExerciseStatusBinding

class ExerciseStatusAdapter(val items : ArrayList<ExerciseModel>) : RecyclerView.Adapter<ExerciseStatusAdapter.ViewHolder>() {

    class ViewHolder(binding: ItemeExerciseStatusBinding) : RecyclerView.ViewHolder(binding.root) {
        val tvItem = binding.tvItem
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemeExerciseStatusBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when{
            ...
            model.getIsCompleted() ->{
                ...
                holder.tvItem.background = ContextCompat.getDrawable(holder.itemView.context,
                    R.drawable.item_cicular_gray_background)
                holder.tvItem.setTextColor(Color.parseColor("#212121"))
